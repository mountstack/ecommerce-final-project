...
const DashboardMenu = ({ isTitle }) => {
  return (
    <aside
      className={`aside pt-1 px-5 overflow-y-auto h-screen scroll-smooth border-r-bg-soft border-r transition-all ease-in-out duration-300 ${
        ...
        <div key={item.id} className="flex flex-col">
          ...
          {item.listItems.map((listItem) => (
            <Link
              ...
              <span
                className={`text-base leading-5 ms-2.5 transition-transform duration-300 ${
                  isTitle
